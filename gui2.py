    ...
    while not stop_threads.is_set():
        try:
            ...
            DD = [
                ...
                client.batchread_wordunits(headdevice="D2", readsize=1),
                client.batchread_wordunits(headdevice="D4", readsize=1)
            ]
...
Content_Entry = customtkinter.CTkEntry(sidebar_frame, textvariable=speed_a1, font=Medium, width=100, state='disabled')
...
Content_Entry = customtkinter.CTkEntry(sidebar_frame, textvariable=angle_a1, font=Medium, width=100, state='disabled')
...
Content_Entry = customtkinter.CTkEntry(sidebar_frame, textvariable=angle_a2, font=Medium, width=100, state='disabled')
...
Content_Label = customtkinter.CTkLabel(sidebar_frame, text="D0:", font=Medium)
Content_Label.grid(row=4, column=1, padx=10, pady=25)

Content_Entry = customtkinter.CTkEntry(sidebar_frame, textvariable=DD0, font=Medium, width=100, state='disabled')
Content_Entry.grid(row=5, column=1, padx=10, pady=25)
...
Content_Label = customtkinter.CTkLabel(sidebar_frame, text="D2:", font=Medium)
Content_Label.grid(row=4, column=2, padx=10, pady=25)

Content_Entry = customtkinter.CTkEntry(sidebar_frame, textvariable=DD2, font=Medium, width=100, state='disabled')
Content_Entry.grid(row=5, column=2, padx=10, pady=25)
...
Content_Label = customtkinter.CTkLabel(sidebar_frame, text="D4:", font=Medium)
Content_Label.grid(row=4, column=3, padx=10, pady=25)

Content_Entry = customtkinter.CTkEntry(sidebar_frame, textvariable=DD4, font=Medium, width=100, state='disabled')
Content_Entry.grid(row=5, column=3, padx=10, pady=25)
